                ...
                <Card.Body>
                  <Container sm>
                    <p>
                      ...
                      environment. These strengths make me a valuable asset who
                      will contribute to success in the workplace.
                    </p>
                  </Container>
                </Card.Body>
              </Accordion.Collapse>
            ...
            <Card>
              ...
              <Accordion.Collapse eventKey="3">
                <Card.Body>
                  ...
                  <ul>
                    <li>
                      Improve and maintain Java Spring, and React applications.
                    </li>
                    <li>
                    ...
                    <li>
                      Implement continuous integration pipelines using Drone and
                      Jenkins.
                    </li>
                  ...
                  <ul>
                    ...
                    <li>
                      Keep track of user stories and highlight development goals
                      for current and future sprints using the scrum
                      methodology.
                    </li>
                  </ul>
                  <p>
                  ...
                  <p>
                    International Development Enterprises (iDE) Global, Denver,
                    CO
                  </p>
                  <p>Responsibilities:</p>
                  <ul>
